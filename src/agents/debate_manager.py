...
class DebateManager:
    def __init__(
        ...
        self.pro_agent = DebaterAgent(pro_config, self._model_client)
        self.con_agent = DebaterAgent(con_config, self._model_client)
    ...
    def _create_model_client(self) -> AnthropicClient:
